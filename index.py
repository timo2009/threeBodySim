...
MAX_LENGTH = 750  # maximale Länge der Linie
...
m_planet = 0.01  # Masse des Planeten

# Positionen und Geschwindigkeiten der drei Körper und des Planeten
def initial_conditions(planet):
    ...
    if planet:
        ...
        r_planet = [5.2, 0.0, 0.0]
        v_planet = [0.0, 0.5, 0.0]
